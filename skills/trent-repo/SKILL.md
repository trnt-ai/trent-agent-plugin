...
- `git@github.com:microsoft/AI-For-Beginners.git` → `microsoft/AI-For-Beginners`
- `https://github.com/microsoft/AI-For-Beginners.git` → `microsoft/AI-For-Beginners`
...
name the user typed ("AI-For-Beginners") before you act on it.
...
Trent project: AI-For-Beginners (last scanned at commit 9862c9a)
```
...
Claude:
1. [git remote -v → microsoft/AI-For-Beginners]
2. [list_projects → project "AI-For-Beginners" carries that repo]
